...
*/
// canivalesvsmisioneros2.cpp : Este archivo contiene la función "main". La ejecución del programa comienza y termina ahí.
//
...
int main() {
	...
	Operation op;
	int operaciones = 70;
	while (operaciones > 20) {
		system("cls");
		operaciones = 0;
		op.jugar(juego, 3, operaciones);

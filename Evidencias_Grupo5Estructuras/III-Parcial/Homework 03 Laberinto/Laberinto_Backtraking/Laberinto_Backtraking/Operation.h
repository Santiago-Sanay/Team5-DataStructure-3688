...
public:
	...
	void generar_t(Matrix matrix);
	void proxima_posicion(int& fila, int& col, Matrix matrix,int direccion);
	bool validate_position(int fila, int col, Matrix matrix);
	int num_ataques(Matrix matrix);
	bool validate_fila(int fil, Matrix matrix);
